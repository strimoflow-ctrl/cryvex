...
import { Instagram, Twitter, Youtube, Music2, Mail, Phone, MapPin, ExternalLink, Github, Linkedin, Send } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-sm text-white hover:text-neon-soft transition-colors"
                    >
                      {footerConfig.email}
                    </a>
                  </div>
                ...
                <li className="flex items-start gap-3">
                  <Send className="w-4 h-4 text-neon-soft/60 mt-0.5" />
                  <div>
                    <p className="text-sm text-white/50">{footerConfig.telegramLabel}</p>
                    <a 
                      href={footerConfig.telegramLink}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-white hover:text-neon-soft transition-colors"
                    >
                      {footerConfig.telegram}
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
...
// Import Code2 for the brand icon
